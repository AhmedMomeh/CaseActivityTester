...
namespace Shared.Activities
{
    public class JobDescription_RouteByGradeAndReportingActivity : ActivityTemplate
    {
        ...
        // NOT escalate to CEO/BoD. Matching only on the exact canonical form
        // means new exception titles must be added explicitly to the list —
        // safer than over-broad matching.
        //
